...
- 2026-09-12 冷启动实验（用户允许虚构库）：无上下文 subagent 按部署 SKILL 跑 ingest/save/query/check 全过（提交与 verify 合规，报告含阅读轨迹）；实证文档欠定义四处、通用性漏点两处（见下一步）；虚构产物留作首批真实数据
