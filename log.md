...
- 日更 cron（部署侧无人值守会话）与真实 profile 接入，随部署落地
...
- 2026-09-19 插件连发：lark 0.2 档案页两形分区 + lark-im 0.1 人际域（群档人档两分、涌现制、关键人、议题按需）；calendar 0.1 + lark-calendar 0.1 时间领地独立（月页两节制、冻结制，lark 源适配器，日更=cron 无人值守会话）；link 0.10/0.11 孤儿判定路径制→type 制→领地值集
- 2026-09-19 index 0.10 溢出减负制：清单 ≤25 条，超窗按子树页数降序切子目录自立索引；根恒在、纯函数重建、索引不发明结构；小库坍缩单索引（合成用例实锤切出泄漏即修）
- 2026-09-19 lark 族立设：基座 0.1（`wiki/lark/<profile>/` 一企业一目录、token 身份证明、trust 懒刷新、命令 lark-map）+ lark-docs 0.1（枢纽三件套、全量映射禁）；registry 扩 type lark
